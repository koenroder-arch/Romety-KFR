/**
 * STRIKT Matching Algoritme voor Welove (Origineel / Back-up)
 * 
 * Strikte validatie:
 * - Geslacht & Zoekvoorkeur (man/vrouw/both/overig)
 * - Relatiedoel (moet exact overeenkomen)
 * - Leeftijdsvoorkeur (beide moeten binnen elkaars range vallen)
 * - Lengtevoorkeur (beide moeten binnen elkaars range vallen)
 * - Land (moet overeenkomen)
 * - Minimaal 1 gedeelde trait of interesse
 * 
 * Om dit strikte algoritme later weer te activeren:
 * Kopieer de inhoud van dit bestand terug naar src/lib/matchUtils.js
 */
