    ...
    >
      ...
      <div className="px-5 mt-4 space-y-4">
        ...
        <div className="mt-4 mb-4 relative">
          <div className={`space-y-2.5 sm:space-y-3 transition-all duration-300 ${!myCheckIn ? 'filter blur-[7px] pointer-events-none select-none opacity-40' : ''}`}>
            {/* 1. Onthul wie je heeft geliked (#FF4B72 - Felroze / Kersenrood) */}
            <button
              onClick={onRevealClick}
              className={`w-full flex items-center justify-between rounded-[20px] sm:rounded-[24px] p-3.5 sm:p-4.5 relative z-30 transition-all active:scale-[0.98] overflow-hidden shadow-sm ${
            ...
            >
              ...
              <div className="flex items-center gap-3 sm:gap-4 z-10 flex-1 min-w-0 pr-2">
                <div 
                  className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl flex items-center justify-center flex-shrink-0 shadow-sm"
                ...
                <div className="text-left flex-1 min-w-0">
                  <p className={`text-[9px] sm:text-[10px] font-black tracking-wider uppercase ${isDark ? 'text-white/60' : 'text-[#FF4B72]'}`}>LIKES</p>
                  <p className={`text-[14px] sm:text-base font-black leading-tight mt-0.5 truncate ${isDark ? 'text-white' : 'text-gray-900'}`}>Onthul wie je heeft geliked</p>
                  <p className={`text-[11px] sm:text-[13px] mt-0.5 truncate ${isDark ? 'text-white/80' : 'text-gray-500'}`}>
                    Bekijk wie jou leuk vindt
                  </p>
                </div>
              </div>
              <div className="relative z-10 flex-shrink-0 flex items-center gap-1.5 sm:gap-2.5">
                <div className="min-w-[24px] h-6 px-1.5 sm:min-w-[28px] sm:h-7 sm:px-2 rounded-full bg-[#FF4B72] text-white text-[11px] sm:text-xs font-black flex items-center justify-center shadow-md">
            ...
            >
              <div className="flex items-center gap-3 sm:gap-4 z-10 flex-1 min-w-0 pr-2">
                ...
                <div className="text-left flex-1 min-w-0">
                  <p className={`text-[9px] sm:text-[10px] font-black tracking-wider uppercase ${isDark ? 'text-white/60' : 'text-[#F9488A]'}`}>SUPER</p>
                  <p className={`text-[14px] sm:text-base font-black leading-tight mt-0.5 truncate ${isDark ? 'text-white' : 'text-gray-900'}`}>Super matches</p>
                  <p className={`text-[11px] sm:text-[13px] mt-0.5 truncate ${isDark ? 'text-white/80' : 'text-gray-500'}`}>
              ...
              <div className="relative z-10 flex-shrink-0 flex items-center gap-1.5 sm:gap-2.5">
                <div className="min-w-[24px] h-6 px-1.5 sm:min-w-[28px] sm:h-7 sm:px-2 rounded-full bg-[#F9488A] text-white text-[11px] sm:text-xs font-black flex items-center justify-center shadow-md">
                  {superMatchCount}
                </div>
                <div className={`w-6 h-6 sm:w-7 sm:h-7 rounded-full ${isDark ? 'bg-white/10 text-white' : 'bg-gray-100 text-gray-700'} flex items-center justify-center`}>
                  <ChevronRight className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
            ...
            >
              ...
              <div className="flex items-center gap-3 sm:gap-4 z-10 flex-1 min-w-0 pr-2">
                ...
                <div className="text-left flex-1 min-w-0">
                  <p className={`text-[9px] sm:text-[10px] font-black tracking-wider uppercase ${isDark ? 'text-white/60' : 'text-[#F445A3]'}`}>HINTS</p>
                  <p className={`text-[14px] sm:text-base font-black leading-tight mt-0.5 truncate ${isDark ? 'text-white' : 'text-gray-900'}`}>Stuur een hint</p>
                  <p className={`text-[11px] sm:text-[13px] mt-0.5 truncate ${isDark ? 'text-white/80' : 'text-gray-500'}`}>
              ...
              <div className="relative z-10 flex-shrink-0 flex items-center gap-1.5 sm:gap-2.5">
                <div className="min-w-[24px] h-6 px-1.5 sm:min-w-[28px] sm:h-7 sm:px-2 rounded-full bg-[#F445A3] text-white text-[11px] sm:text-xs font-black flex items-center justify-center shadow-md">
            ...
            >
              <div className="flex items-center gap-3 sm:gap-4 z-10 flex-1 min-w-0 pr-2">
                ...
                <div className="text-left flex-1 min-w-0">
                  <p className={`text-[9px] sm:text-[10px] font-black tracking-wider uppercase ${isDark ? 'text-white/60' : 'text-[#EE42BC]'}`}>GAMES</p>
                  <p className={`text-[14px] sm:text-base font-black leading-tight mt-0.5 truncate ${isDark ? 'text-white' : 'text-gray-900'}`}>Spellen</p>
                  <p className={`text-[11px] sm:text-[13px] mt-0.5 truncate ${isDark ? 'text-white/80' : 'text-gray-500'}`}>
              ...
              <div className="relative z-10 flex-shrink-0 flex items-center gap-1.5 sm:gap-2.5">
                <div className="min-w-[24px] h-6 px-1.5 sm:min-w-[28px] sm:h-7 sm:px-2 rounded-full bg-[#EE42BC] text-white text-[11px] sm:text-xs font-black flex items-center justify-center shadow-md">
                  {activeGameCount}
                </div>
                <div className={`w-6 h-6 sm:w-7 sm:h-7 rounded-full ${isDark ? 'bg-white/10 text-white' : 'bg-gray-100 text-gray-700'} flex items-center justify-center`}>
                  <ChevronRight className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
            ...
            >
              <div className="flex items-center gap-3 sm:gap-4 z-10 flex-1 min-w-0 pr-2">
                ...
                <div className="text-left flex-1 min-w-0">
                  <p className={`text-[9px] sm:text-[10px] font-black tracking-wider uppercase ${isDark ? 'text-white/60' : 'text-[#EA3FD3]'}`}>VIP DEALS</p>
                  <p className={`text-[14px] sm:text-base font-black leading-tight mt-0.5 truncate ${isDark ? 'text-white' : 'text-gray-900'}`}>Bekijk VIP kortingen</p>
                  <p className={`text-[11px] sm:text-[13px] mt-0.5 truncate ${isDark ? 'text-white/80' : 'text-gray-500'}`}>
              ...
              <div className="relative z-10 flex-shrink-0 flex items-center gap-1.5 sm:gap-2.5">
                <div className="min-w-[24px] h-6 px-1.5 sm:min-w-[28px] sm:h-7 sm:px-2 rounded-full bg-[#EA3FD3] text-white text-[11px] sm:text-xs font-black flex items-center justify-center shadow-md">
